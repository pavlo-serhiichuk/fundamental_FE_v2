...
describe('Counter', () => {
  ...
  test('render', () => {
    expect(screen.getByTestId("counter-number-local")).toHaveTextContent('10')
  })

  test('increment', () => {
    const incBtn = screen.getByTestId('counter-btn-increment')
    fireEvent.click(incBtn)
    expect(screen.getByTestId("counter-number-local")).toHaveTextContent('11')
  })

  test('decrement', () => {
    const decBtn = screen.getByTestId('counter-btn-decrement')
    fireEvent.click(decBtn)
    expect(screen.getByTestId('counter-number-local')).toHaveTextContent('9')
  })
})
